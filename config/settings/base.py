...
ROOT_DIR = environ.Path(__file__) - 3  # (idi/config/settings/base.py - 3 = idi/)
APPS_DIR = ROOT_DIR.path('idi')
...
MIGRATION_MODULES = {
    'sites': 'idi.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'idi.users.adapters.SocialAccountAdapter'

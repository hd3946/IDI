...
from idi.users import models as user_models
from idi.users import serializers as user_serializers
from idi.notifications import views as notification_views
